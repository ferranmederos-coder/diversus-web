    ...
    <SiteLayout heroTop>
      ...
      <section className="section bg-white">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[440px]">
                ...
                >
                  ...
                  <img
                    ...
                    loading="lazy"
                  />
                  <div className="absolute inset-0" style={{ background: BRAND_TINTS[brand.id] }} />
                  <div
                    className="absolute inset-0"
                    style={{ background: "linear-gradient(to top, rgba(15,15,15,0.92) 0%, rgba(15,15,15,0.25) 65%, transparent 100%)" }}
                  />
                ...
                <div className={`flex flex-col justify-center px-10 md:px-14 py-12 bg-white ${odd ? "lg:order-1" : "lg:order-2"}`}>
                  <div className="mb-6">
                  ...
                  {brand.url && (
                    <BrandCTA href={brand.url} accentColor={BRAND_ACCENT_HOVER[brand.id]}>
        ...
        {devBrands.map(brand => (
          ...
          >
            <div className="relative overflow-hidden group" style={{ background: "var(--navy)" }}>
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img
                src={UNSPLASH.foods}
                alt=""
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-8">
              {copy.methodology.items.map(({ n, Icon, title, body }, i) => (
                ...
                >
                  ...
                  <span className="font-mono text-orange/30 text-3xl font-bold leading-none mb-3 block">{n}</span>
      ...
      >
        ...
        <div
          className="absolute inset-0"
          style={{ background: "linear-gradient(105deg, rgba(15,15,15,0.80) 0%, rgba(15,15,15,0.58) 45%, rgba(15,15,15,0.42) 100%)" }}
        />
        <div className="absolute inset-0 blueprint-grid opacity-20" />
      ...
      <section className="section-sm relative overflow-hidden bg-white">
        <div
          className="absolute inset-0 pointer-events-none"
          style={{ background: "radial-gradient(ellipse 60% 60% at 50% 50%, rgba(183,155,106,0.05) 0%, transparent 70%)" }}
        />
        <motion.div
